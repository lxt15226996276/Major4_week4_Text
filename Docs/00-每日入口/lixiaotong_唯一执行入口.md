...
**十套练习（W4 v5 双轨）**：[`W4 §二-C`](../01-成长路线/W4-RPG周-当前.md) · **试题 N = Exam0N** · 当前 **试题7 Exam07 第1步** · Exam01 R1 第8步 **暂停**
...
| **工程状态** | Exam01～10 **已重置** · **当前 R2 试题7 第1步** · R1 Exam01 第8步 **暂停** · 见 [`W4 §二-C §1`](../01-成长路线/W4-RPG周-当前.md) |
...
### 2026-07-13 · **Exam07 / 试题7 · 第 6 步** ← 当前（**Play 交付**）

| 任务 | 说明 |
|------|------|
| **卷面 L1** | 四条考点 Play 全链 · Console **成功+失败** · 断网自检 |
| **待补** | `BuyHp`/`BuyMp` 金币不足分支 **`Debug.Log("购买失败")`** |
| 讲义 | [`Exam07/分步教程.md`](../../Assets/Exams/Exam07/Docs/分步教程.md) **第 5～6 步** |
| 交付口令 | 全通过后 **「Exam07 交付完成」** |
