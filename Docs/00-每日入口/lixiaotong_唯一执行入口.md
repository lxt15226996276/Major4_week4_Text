...
| **工程状态** | Exam01～10 **已重置**（仅 Prefab 素材池）· **Exam01 脚本/场景 W4 重做中** · W3 Lab 归档保留 |
| **W2 试卷** | **学员确认已全部完成**（2026-07-11）· 不以 W2 归档欠账表排当前课 |
...
**W4 踩坑（Exam01 重做 · 2026-07-11 已录入）**：[`踩坑记忆库 §二-O`](../02-学员档案/踩坑记忆库_lixiaotong.md) · **A1 动画事件 public** · **Cam1 pelvis/Main_Camera 运镜骨** · **SK2 Trigger=Skill1/2/4/6** · **BG1 背包防重复** · **W2 已全部完成勿按欠账表排课**
...
> **W2 状态（学员确认 2026-07-11）**：**十套题已全部完成** · 不再按 W2 归档「欠账」排课 · W4 主做 **Exam01 重做交付** → **Stage01_W4 RPG**

### 2026-07-11 · **Exam01 · 第 8 步交付** ← 当前

| 任务 | 说明 |
|------|------|
| 核心 | 断网全流程 · Build 0→1 · 注释 · Console 0 Error |
| 讲义 | [`分步教程.md`](../../Assets/Exams/Exam01/Docs/分步教程.md) **第 8 步** |
| 工作目录 | `Assets/Exams/Exam01/` |
| L1 验收 | 登录→背包20格→技能弹窗→4技能动画→弹窗可关 |
| **P-L1 自检** | `PlayerAnimEvent` **public** · 删 Editor using · `MainUIController` OnDestroy · 背包防重复（见 [**§二-O**](../02-学员档案/踩坑记忆库_lixiaotong.md)） |
| 进度 | 第 1～7 步 **✅** · 第 8 步 **进行中** |

### 2026-07-09 · **Exam01（登录+背包+技能）· 第 1～7 步**（✅ 已完成）

| 任务 | 说明 |
|------|------|
| 核心 | 读题 + 两场景 + Login/MainUI/背包/技能/Animator |
| 踩坑已录入 | [**踩坑记忆库 §二-O**](../02-学员档案/踩坑记忆库_lixiaotong.md) v1.19 |
