...
### 2026-07-12 · **Exam07 / 试题7 · 第 1 步** ← 当前（**W4 卷面 · 轨 A**）

| 任务 | 说明 |
|------|------|
| **卷面 L1** | **单 Game 场景** · 动态主角+相机跟随+商城购HP/MP（[`预制体盘点 §三`](../06-Exam工程/预制体盘点_W4.md)） |
| **不要求** | ❌ Login 场景 · ❌ Loading · ❌ Dictionary（**W4d5** · 非卷面） |
| 核心 | `Exam07_Game` · 拖 **`GameCanvas`** · **`EventSystem`** · 可选 **`Cube`** |
| Prefab 主用 | **`GameCanvas`** · **`Cube`** · 第4步 **`BtnMute`** |
| Prefab 备用 | `LoginSceneUI` = **†W2/U17 P+1** · **本套卷面不建** |
| 讲义 | [`Exam07/分步教程.md`](../../Assets/Exams/Exam07/Docs/分步教程.md) |
| 推荐位 | **R2** · R1 Exam01 第8步 **暂停** |
| ⚠️ **K1** | 「进行下一步」= **只教 · 不改仓库** |
...
| 2026-07-12 | **W4d5** · Exam07 **卷面=Game单场景** · 废止 †W2 Login 必做 · Exam07 讲义 |
