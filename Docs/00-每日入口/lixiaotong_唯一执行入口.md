...
| **工程状态** | Exam01～10 **已重置** · **W4 本周只练 Exam01**（第 8 步待验收）· 见 [`W4 §二-C §1`](../01-成长路线/W4-RPG周-当前.md) |
...
### 2026-07-11 · **Exam07 / 试题7 · 第 1 步** ← 当前（**轨 A · 第七套**）

| 任务 | 说明 |
|------|------|
| 类型 | **A+C+D** · 动态主角+相机跟随+商城购HP/MP |
| 核心 | 两场景 `Exam07_Login` · `Exam07_Game` · Build 0/1 |
| Prefab | `LoginSceneUI` · `GameCanvas` · `Cube` · `BtnMute`（[`预制体盘点`](../../Docs/06-Exam工程/预制体盘点_W4.md)） |
| 推荐位 | **= R2**（R1 Exam01 第8步 **未归档** · 学员跳转） |
| †W2 | L1+P-L1 ✅ · P+1 3/6 · **读码参照** · **W4 从零重写** |
| ⚠️ **K1** | 「进行下一步」= **只教 · 不改仓库** |
...
| 2026-07-11 | **§二-C v5 双轨** · 试题N=Exam0N + 推荐序R# · 参评分 · R1→R2=试题7 |
