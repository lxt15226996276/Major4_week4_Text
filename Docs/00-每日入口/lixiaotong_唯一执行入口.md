...
**档案维护（v7.14）**：**开下一套题** 或 **「ExamXX 交付完成」** → AI **同一轮 §11.7 仅录入 Docs**（**禁止**代改 Scripts · 见踩坑 **K1d**）
...
**W4 踩坑（Exam01 重做 · 2026-07-11 已录入）**：[`踩坑记忆库 §二-O`](../02-学员档案/踩坑记忆库_lixiaotong.md) · **A1 动画事件 public** · **Cam1 pelvis/Main_Camera 运镜骨** · **SK2 Trigger=Skill1/2/4/6** · **BG1 背包防重复** · **K1d 交付仅 Docs** · **W2 已全部完成勿按欠账表排课**
...
> **W2 状态（学员确认 2026-07-11）**：**十套题已全部完成** · 不再按 W2 归档「欠账」排课 · W4 主做 **Exam01 重做**（第 8 步待 Play）→ **Stage01_W4 RPG**

### 2026-07-11 · **Exam01 · 第 8 步待 Play 验收** ← 当前

| 任务 | 说明 |
|------|------|
| 状态 | **第 1～7 步已完成** · 七脚本已从 Git **还原为学员自写版**（撤销误触「交付」时代改 · **K1d**） |
| 第 8 步 | Play 全链验收 · P-L1 自查：**A1 public** · **SK3** 删 Editor using · **BG1** 防重复 · **UI2** OnDestroy |
| 归档 | 验收通过后说 **「Exam01 交付完成」** → AI **仅 §11.7 改档案** · 或 **开下一套** 自动归档 |
| 踩坑 | [**K1d**](../02-学员档案/踩坑记忆库_lixiaotong.md) · [**§二-O**](../02-学员档案/踩坑记忆库_lixiaotong.md) 技术项 |
...
| 2026-07-11 | **K1d** · 「交付 Exam01」误代改 7 脚本 → **git 还原** · §11.7 **仅 Docs** · 当前 **Exam01 第 8 步待 Play** |
