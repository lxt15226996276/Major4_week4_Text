...
**十套练习（W4 v5 双轨）**：[`W4 §二-C`](../01-成长路线/W4-RPG周-当前.md) · **试题 N = Exam0N** · 当前 **试题6 Exam06 第1步** · Exam07 **中断** · Exam01 R1 第8步 **暂停**
...
| **工程状态** | Exam01～10 **已重置** · **当前 试题6 Exam06 第1步** · Exam07 **W4中断** · R1 Exam01 第8步 **暂停** |
...
### 2026-07-13 · **Exam06 / 试题6 · 第 1 步** ← 当前（**W4 卷面 · 轨 A**）

| 任务 | 说明 |
|------|------|
| **卷面 L1** | Dictionary → Loading 4s → 人物面板 · 商城 +100～+400（[`预制体盘点 §三`](../06-Exam工程/预制体盘点_W4.md)） |
| 核心 | 三场景 · Build **0 Login · 1 Loading · 2 Game** |
| Prefab | **`Exam06/LoadingCanvas`** · **`Exam06/GameSceneUI`** · Login → **`Exam02/03 LoginSceneUI`** |
| 讲义 | [`Exam06/分步教程.md`](../../Assets/Exams/Exam06/Docs/分步教程.md) **第 1 步** |
| ⚠️ **K1** | 「进行下一步」= **只教 · 不改仓库** |
...
| 未正式交付 | 未说「Exam07 交付完成」· 第6步断网全链未验 |
| 续做 | **「继续 Exam07 第6步」** |
