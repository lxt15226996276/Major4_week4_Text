...
**十套练习序（W4 v3）**：[`W4 §二-C §0+§3`](../01-成长路线/W4-RPG周-当前.md) · **本周仅 Exam01** · 下一套 **#2 Exam07** · 问「为什么」→ **必读 §0 复盘**
...
| 任务 | 说明 |
|------|------|
| 状态 | 第 1～7 步完成 · **本周唯一在做的一套** |
| 第 8 步 | Play 全链 · P-L1 自查（A1/SK3/BG1/UI2） |
| 练习队列 | **#1/10** · 下一套 **#2 Exam07** · 序与「为何」→ [`W4 §二-C`](../01-成长路线/W4-RPG周-当前.md) |
| 踩坑 | **K1d** · **W4d1**（勿用 §六 W2 沉底）· **W4d3**（须解释为何） |
...
| 2026-07-11 | **§二-C v3** · v2 排课复盘 · **W4d1/W4d3** · 本周仅 Exam01 · #2=**Exam07** |
